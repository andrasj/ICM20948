#ifndef _ICM20948Def_H_
#define _ICM20948Def_H_
...
#define AK09916_I2C_SLAVE_ADDRESS     AK0991x_DEFAULT_I2C_ADDR
...
//  Gyro LPF options
#define BIT_GYRO_FCHOICE        0x01                        /**< Gyro Digital Low-Pass Filter enable bit    */
#define SHIFT_GYRO_FS_SEL       1                           /**< Gyro Full Scale Select bit shift           */
#define SHIFT_GYRO_DLPCFG       3                           /**< Gyro DLPF Config bit shift                 */
#define MASK_GYRO_FULLSCALE     0x06                        /**< Gyro Full Scale Select bitmask             */
#define MASK_GYRO_BW            0x39                        /**< Gyro Bandwidth Select bitmask              */
#define GYRO_LPF_12100HZ         (0x00 << SHIFT_GYRO_DLPCFG)                                     /**< Gyro Bandwidth = 12100 Hz */
#define GYRO_LPF_360HZ           ( (0x07 << SHIFT_GYRO_DLPCFG) | BIT_GYRO_FCHOICE)      /**< Gyro Bandwidth = 360 Hz   */
#define GYRO_LPF_200HZ           ( (0x00 << SHIFT_GYRO_DLPCFG) | BIT_GYRO_FCHOICE)      /**< Gyro Bandwidth = 200 Hz   */
#define GYRO_LPF_150HZ           ( (0x01 << SHIFT_GYRO_DLPCFG) | BIT_GYRO_FCHOICE)      /**< Gyro Bandwidth = 150 Hz   */
#define GYRO_LPF_120HZ           ( (0x02 << SHIFT_GYRO_DLPCFG) | BIT_GYRO_FCHOICE)      /**< Gyro Bandwidth = 120 Hz   */
#define GYRO_LPF_51HZ            ( (0x03 << SHIFT_GYRO_DLPCFG) | BIT_GYRO_FCHOICE)      /**< Gyro Bandwidth = 51 Hz    */
#define GYRO_LPF_24HZ            ( (0x04 << SHIFT_GYRO_DLPCFG) | BIT_GYRO_FCHOICE)      /**< Gyro Bandwidth = 24 Hz    */
#define GYRO_LPF_12HZ            ( (0x05 << SHIFT_GYRO_DLPCFG) | BIT_GYRO_FCHOICE)      /**< Gyro Bandwidth = 12 Hz    */
#define GYRO_LPF_6HZ             ( (0x06 << SHIFT_GYRO_DLPCFG) | BIT_GYRO_FCHOICE)      /**< Gyro Bandwidth = 6 Hz     */

//  Gyro FSR options

#define GYRO_FULLSCALE_250DPS   (0x00 << SHIFT_GYRO_FS_SEL)    /**< Gyro Full Scale = 250 deg/sec  */
#define GYRO_FULLSCALE_500DPS   (0x01 << SHIFT_GYRO_FS_SEL)    /**< Gyro Full Scale = 500 deg/sec  */
#define GYRO_FULLSCALE_1000DPS  (0x02 << SHIFT_GYRO_FS_SEL)    /**< Gyro Full Scale = 1000 deg/sec */
#define GYRO_FULLSCALE_2000DPS  (0x03 << SHIFT_GYRO_FS_SEL)    /**< Gyro Full Scale = 2000 deg/sec */

//  Accel FSR options
#define SHIFT_ACCEL_FS          1                           /**< Accel Full Scale Select bit shift                      */
#define MASK_ACCEL_FULLSCALE    0x06                        /**< Accel Full Scale Select bitmask                        */
#define ACCEL_FULLSCALE_2G      (0x00 << SHIFT_ACCEL_FS)    /**< Accel Full Scale = 2 g  */
#define ACCEL_FULLSCALE_4G      (0x01 << SHIFT_ACCEL_FS)    /**< Accel Full Scale = 4 g  */
#define ACCEL_FULLSCALE_8G      (0x02 << SHIFT_ACCEL_FS)    /**< Accel Full Scale = 8 g  */
#define ACCEL_FULLSCALE_16G     (0x03 << SHIFT_ACCEL_FS)    /**< Accel Full Scale = 16 g */

//  Accel LPF options
#define BIT_ACCEL_FCHOICE       0x01                        /**< Accel Digital Low-Pass Filter enable bit               */
#define SHIFT_ACCEL_DLPCFG      3                           /**< Accel DLPF Config bit shift                            */
#define MASK_ACCEL_BW           0x39                        /**< Accel Bandwidth Select bitmask                         */

#define ACCEL_LPF_1210HZ         (0x00 << SHIFT_ACCEL_DLPCFG)                           /**< Accel Bandwidth = 1210 Hz  */
#define ACCEL_LPF_470HZ          ( (0x07 << SHIFT_ACCEL_DLPCFG) | BIT_ACCEL_FCHOICE)    /**< Accel Bandwidth = 470 Hz   */
#define ACCEL_LPF_246HZ          ( (0x00 << SHIFT_ACCEL_DLPCFG) | BIT_ACCEL_FCHOICE)    /**< Accel Bandwidth = 246 Hz   */
#define ACCEL_LPF_111HZ          ( (0x02 << SHIFT_ACCEL_DLPCFG) | BIT_ACCEL_FCHOICE)    /**< Accel Bandwidth = 111 Hz   */
#define ACCEL_LPF_50HZ           ( (0x03 << SHIFT_ACCEL_DLPCFG) | BIT_ACCEL_FCHOICE)    /**< Accel Bandwidth = 50 Hz    */
#define ACCEL_LPF_24HZ           ( (0x04 << SHIFT_ACCEL_DLPCFG) | BIT_ACCEL_FCHOICE)    /**< Accel Bandwidth = 24 Hz    */
#define ACCEL_LPF_12HZ           ( (0x05 << SHIFT_ACCEL_DLPCFG) | BIT_ACCEL_FCHOICE)    /**< Accel Bandwidth = 12 Hz    */
#define ACCEL_LPF_6HZ            ( (0x06 << SHIFT_ACCEL_DLPCFG) | BIT_ACCEL_FCHOICE)    /**< Accel Bandwidth = 6 Hz     */
...
#define I2C_MST_FREQ_345_6_MAX400HZ     0x07
